...
const translations = {
    en: {
        ...
        login: "Login",
        signup: "Sign Up",
        heroTitle: "Preserve Your Heritage",
    ...
    fr: {
        ...
        login: "Connexion",
        signup: "S'inscrire",
        heroTitle: "Preservez Votre Heritage",
...
// Authentication functions - redirects to rasin.pyebwa.com/login-standalone.html
function redirectToLogin() {
    console.log('Redirecting to standalone login page on rasin.pyebwa.com');
    window.location.href = 'https://rasin.pyebwa.com/login-standalone.html';
}
...
console.log('App initialization complete - Authentication redirects to rasin.pyebwa.com/login-standalone.html');
