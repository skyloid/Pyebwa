...
try:
    ...
    print("\n✅ Footer translation updated!")
    print("\nKey change:")
    print("- Changed 'Technologies Humanitaire Inc.' to 'Technologies Humanitaires Inc.'")
    print("- Added the 's' to Humanitaires in French and Creole translations")
    print("- Updated in app.js, language.js, and translations-pages.js")
