...
try:
    ...
    print("\nKey change:")
    print("- Changed 'Technologies Humanitaires Inc.' to 'Technologies Humanitaires'")
    print("- Removed 'Inc.' from French and Creole translations")
    print("- English version remains 'Human Level Technologies Inc.'")
